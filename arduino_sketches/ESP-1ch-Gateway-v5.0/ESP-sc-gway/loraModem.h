...
struct pins {
  ...
  uint8_t dio1=33;    // GPIO26 / Used for CAD, may or not be shared with DIO0
  uint8_t dio2=32;    // GPIO26 / Used for frequency hopping, don't care
  uint8_t ss=15;      // GPIO18 / Dx. Select pin connected to GPIO18
  uint8_t rst=16;     // GPIO0 / D3. Reset pin not used 
} pins;

#define SCK 14        // Check
#define MISO 13       // Check
#define MOSI 12       // Check
#define RST 16        // Check  // Not Used
#define SS 15
