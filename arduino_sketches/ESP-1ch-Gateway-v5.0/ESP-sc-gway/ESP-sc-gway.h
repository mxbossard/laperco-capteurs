...
#define AP_NAME "admin"
#define AP_PASSWD "bigmax"
...
#define _DESCRIPTION "max ESP Gateway test"			// Name of the gateway
#define _EMAIL "mxbossard@protonmail.com"		// Owner
#define _PLATFORM "ESP32"
#define _LAT 47.900576
#define _LON 1.913680
#define _ALT 120				// Altitude
